...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        CommunicationSatellite c1 = new CommunicationSatellite("Связь-1", 0.85, 500);
        CommunicationSatellite c2 = new CommunicationSatellite("Связь-2", 0.75, 1000);
        ...
        for (Satellite s : constellation.getSatellites()) {
            if (s.activate()) {
                ...
                System.out.println("🛑 " + s.getName() + ": Ошибка активации (заряд: "
                        + (int) (s.getBatteryLevel() * 100) + "%)");
            }
        }
